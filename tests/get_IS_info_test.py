...
class TestGetISInfo(unittest.TestCase):
    ...
    def test_write_info(self):
        ...
        actual = write_info(self.TEST_TAB_FILE, prodigal_info, interpro_info, cobs_info, self.TEST_OUTPUT_PREFIX)
    ...
    def test_arguments(self):
        actual = get_arguments().parse_args(
            ...
            '--interproscan_out', 'interproscan_out', '--output_prefix', 'output_prefix'])
    ...
    def test_main(self, mock_write_info, mock_get_cobs_info, mock_get_interproscan_info, mock_get_prodigal_info):
